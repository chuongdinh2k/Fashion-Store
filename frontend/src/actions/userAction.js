...
export const register = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${process.env.REACT_APP_API_KEY}/api/v1/register`,
      userData,
      config
    );
...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_KEY}/api/v1/me`
    );
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${process.env.REACT_APP_API_KEY}/api/v1/password/forgot`,
      email,
      config
    );
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_API_KEY}/api/v1/password/reset/${token}`,
      passwords,
      config
    );
...
export const getAllUsers = (token) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API_KEY}/api/v1/admin/users`,
      {
